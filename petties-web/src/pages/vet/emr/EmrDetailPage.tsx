...
export const EmrDetailPage = () => {
    ...
    console.log('[EmrDetail] Permissions Check:', {
        ...
        currentUserId,
        emrVetId: emr.vetId,
        idsMatch: String(currentUserId) === String(emr.vetId),
    ...
    const canEdit = !emr.isLocked && String(currentUserId) === String(emr.vetId) && isWithin24h;
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-stone-400 mt-0.5">
                                Tạo bởi: <span className="font-medium text-stone-600">{emr.vetName}</span> tại <span className="font-medium text-stone-600">{emr.clinicName}</span>
                            </div>
                        </div>
                    </div>
                    {canEdit && (
