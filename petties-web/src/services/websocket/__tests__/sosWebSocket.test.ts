...
// Mock STOMP Client - use class so `new Client()` works
vi.mock('@stomp/stompjs', () => {
    const mockSubscribe = vi.fn().mockReturnValue({ unsubscribe: vi.fn() })
    function MockClient(this: { activate: () => void; deactivate: () => void; subscribe: ReturnType<typeof vi.fn>; publish: ReturnType<typeof vi.fn> }, config: { onConnect?: (frame: unknown) => void }) {
