...
export interface ClinicNotification {
  ...
  clinicId?: string
  clinicName?: string
  type: 'APPROVED' | 'REJECTED' | 'PENDING' | 'CLINIC_PENDING_APPROVAL' | 'STAFF_SHIFT_ASSIGNED' | 'STAFF_SHIFT_UPDATED' | 'STAFF_SHIFT_DELETED' | 'BOOKING_CREATED' | 'BOOKING_CONFIRMED' | 'BOOKING_ASSIGNED' | 'BOOKING_CANCELLED' | 'BOOKING_CHECKIN' | 'BOOKING_COMPLETED' | 'STAFF_ON_WAY' | 'CLINIC_VERIFIED'
  message: string
  reason?: string
  read: boolean
  createdAt: string
