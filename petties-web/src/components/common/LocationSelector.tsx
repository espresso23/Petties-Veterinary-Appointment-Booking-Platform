...
export function LocationSelector({
    ...
    const isMatch = useCallback((apiName: string, value: string) => {
    ...
    useEffect(() => {
        if (provinces.length > 0 && provinceValue && provinceValue !== lastExternalProvince.current) {
            ...
            if (found) {
                ...
                setTimeout(() => setIsManualProvince(true), 0);
            }
        }
    }, [provinceValue, provinces, isMatch]);
    ...
    useEffect(() => {
        if (districts.length > 0 && districtValue && districtValue !== lastExternalDistrict.current) {
            ...
            if (found) {
                ...
                setTimeout(() => setIsManualDistrict(true), 0);
            }
        }
    }, [districtValue, districts, isMatch]);
    ...
    useEffect(() => {
        if (wards.length > 0 && wardValue && wardValue !== lastExternalWard.current) {
            ...
            if (found) {
                ...
                setTimeout(() => setIsManualWard(true), 0);
            }
        }
    }, [wardValue, wards, isMatch]);
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 ${className}`}>
            ...
            <div className="relative">
                <div className="flex justify-between items-center mb-1 px-1">
                    ...
                    <button
                        type="button"
                        onClick={() => !disabled && setIsManualProvince(!isManualProvince)}
                        className={`text-[10px] font-bold text-amber-700 flex items-center gap-1 ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:underline'}`}
                        disabled={disabled}
                    >
                ...
                {isManualProvince ? (
                    <input
                        ...
                        className="input-brutal w-full bg-white font-bold disabled:bg-stone-100 disabled:cursor-not-allowed"
            ...
            <div className="relative">
                <div className="flex justify-between items-center mb-1 px-1">
                    ...
                    <button
                        type="button"
                        onClick={() => !disabled && setIsManualDistrict(!isManualDistrict)}
                        className={`text-[10px] font-bold text-amber-700 flex items-center gap-1 ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:underline'}`}
                        disabled={disabled}
                    >
                ...
                {isManualDistrict ? (
                    ...
                    <BrutalSelect
                        ...
                        disabled={disabled || selectedProvinceCode === 'none'}
            ...
            <div className="relative">
                <div className="flex justify-between items-center mb-1 px-1">
                    ...
                    <button
                        type="button"
                        onClick={() => !disabled && setIsManualWard(!isManualWard)}
                        className={`text-[10px] font-bold text-amber-700 flex items-center gap-1 ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:underline'}`}
                        disabled={disabled}
                    >
                ...
                {isManualWard ? (
                    ...
                    <BrutalSelect
                        ...
                        disabled={disabled || selectedDistrictCode === 'none'}
