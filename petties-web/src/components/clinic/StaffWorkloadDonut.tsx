...
export function StaffWorkloadDonut({
    ...
    const labels = ['Today', 'Awaiting intake', 'In progress', 'Upcoming list']
    ...
    if (total === 0) {
        return (
            <div className="border-4 border-stone-900 bg-white p-6 shadow-brutal">
                <h3 className="text-sm font-bold text-stone-900 uppercase tracking-wide mb-2">Workload mix</h3>
                <p className="text-stone-500 text-sm text-center py-8">No workload data yet</p>
            </div>
        )
    }
