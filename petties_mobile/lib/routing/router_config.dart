...
import '../ui/vet/booking/vet_bookings_screen.dart';
import '../ui/vet/vet_booking_detail_screen.dart';
import '../ui/vet/patient/patient_screens.dart';
import '../ui/vet/patient/vaccination_form_screen.dart';
  ...
  static GoRouter createRouter(AuthProvider authProvider) {
    return GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          path: AppRoutes.vetBookings,
          builder: (context, state) => const VetBookingsScreen(),
        ),
        ...
        GoRoute(
          path: AppRoutes.vetVaccinationForm,
          builder: (context, state) {
