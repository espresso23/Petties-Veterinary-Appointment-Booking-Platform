...
class VetBookingDetailScreen extends StatefulWidget {
  ...
  const VetBookingDetailScreen({super.key, required this.bookingId});

  @override
  State<VetBookingDetailScreen> createState() => _VetBookingDetailScreenState();
}
...
class _VetBookingDetailScreenState extends State<VetBookingDetailScreen> {
  ...
  Widget _buildContent() {
    ...
    // Filter services assigned to current vet
    final myServices = _booking!.services
        .where((s) => s.assignedVetId == currentUserId)
        .toList();
