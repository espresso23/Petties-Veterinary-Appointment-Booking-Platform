          ...
          child: _isLoading
              ...
              : TabBarView(
                  ...
                  children: [
                    ...
                    // Tab 2: Đã duyệt (CONFIRMED - Only future ones)
                    _buildBookingList(_bookings
                        .where((b) =>
                            ['CONFIRMED'].contains(b.status) &&
                            !_isToday(b.bookingDate))
                        .toList()),

                    // Tab 3: Đang diễn ra (IN_PROGRESS + Today's CONFIRMED)
                    _buildBookingList(_bookings
                        .where((b) =>
                            (['IN_PROGRESS'].contains(b.status)) ||
                            (['CONFIRMED'].contains(b.status) &&
                                _isToday(b.bookingDate)))
                        .toList()),
