...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('agent_type', sa.Enum('main', 'booking', 'medical', 'product', name='agenttype'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('name', sa.String(100), nullable=False),
        sa.Column('tool_type', sa.Enum('code_based', 'api_based', name='tooltypeenum'), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
