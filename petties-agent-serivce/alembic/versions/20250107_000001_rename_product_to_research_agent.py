...
def upgrade() -> None:
    # Step 1: Add 'research' value to AgentType enum
    # PostgreSQL requires creating a new enum, updating column, then dropping old enum
    ...
    # Step 3: Update agent name from 'product_agent' to 'research_agent'
    op.execute("""
        UPDATE agents 
