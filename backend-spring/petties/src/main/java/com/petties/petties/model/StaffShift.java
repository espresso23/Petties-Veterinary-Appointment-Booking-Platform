...
/**
 * Entity representing a Staff's work shift
 *
 * One StaffShift = one work period for a staff on a specific date
 * System auto-generates 30-minute Slots when a shift is created
 *
 * Business Rules:
 * - A staff can have MULTIPLE shifts per day (no time overlap allowed)
...
@Table(name = "staff_shifts", indexes = {
        @Index(name = "idx_shift_staff_date", columnList = "staff_id, work_date"),
