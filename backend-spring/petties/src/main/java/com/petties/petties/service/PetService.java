...
public class PetService {
    ...
    @Transactional(readOnly = true)
    public List<com.petties.petties.dto.pet.VetPatientDTO> getPatientsForVet(UUID clinicId, UUID vetId) {
        ...
        List<com.petties.petties.model.enums.BookingStatus> activeStatuses = List.of(
                ...
                com.petties.petties.model.enums.BookingStatus.CHECK_IN,
                com.petties.petties.model.enums.BookingStatus.IN_PROGRESS);

        // Fetch bookings assigned to this Vet (Today onwards)
        List<com.petties.petties.model.Booking> myBookings = bookingRepository
                .findByAssignedVetIdAndBookingDateBetweenAndStatusIn(
                        vetId, today, today.plusYears(1), activeStatuses);

        java.util.Map<UUID, com.petties.petties.dto.pet.VetPatientDTO> patientMap = new java.util.HashMap<>();
        ...
        for (com.petties.petties.model.Booking b : myBookings) {
            ...
            com.petties.petties.dto.pet.VetPatientDTO dto = patientMap.getOrDefault(pet.getId(), mapToVetDto(pet));
        ...
        // patients)
        // Filter out PENDING bookings - vets should only see confirmed/assigned
        // bookings
        ...
        for (com.petties.petties.model.Booking b : clinicBookingsToday) {
            ...
            com.petties.petties.dto.pet.VetPatientDTO dto = patientMap.get(pet.getId());
            if (dto == null) {
        ...
        for (EmrRecord emr : clinicEmrs) {
            if (!patientMap.containsKey(emr.getPetId())) {
                petRepository.findById(emr.getPetId()).ifPresent(pet -> {
                    com.petties.petties.dto.pet.VetPatientDTO dto = mapToVetDto(pet);
                ...
                com.petties.petties.dto.pet.VetPatientDTO dto = patientMap.get(emr.getPetId());
        ...
        List<com.petties.petties.dto.pet.VetPatientDTO> sortedList = new java.util.ArrayList<>(patientMap.values());
    ...
    private com.petties.petties.dto.pet.VetPatientDTO mapToVetDto(Pet pet) {
        // Calculate age
        int ageYears = 0;
        int ageMonths = 0;
        ...
        return com.petties.petties.dto.pet.VetPatientDTO.builder()
                .petId(pet.getId())
                .petName(pet.getName())
